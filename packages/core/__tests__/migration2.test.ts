...
describe('migrations v2–v6: FTS removal, embeddings, outbox, okf edges, entity manifests; setup ends at version 10', () => {
  ...
  it('v1 DB: FTS5 table + triggers dropped, embedding column added, version becomes 10', async () => {
